...
public class CombatState : MonoBehaviour
{
    ...
    void CreateTeamA()
    {
        ...
        CreateCombatSailor("Scrub", new CombatPosition(0, 1), Team.A);
        CreateCombatSailor("Scrub", new CombatPosition(1, 0), Team.A);
    }
    void CreateTeamB()
    {
        CreateCombatSailor("Salvatafo", new CombatPosition(0, 1), Team.B);
        CreateCombatSailor("Galdalf", new CombatPosition(1, 1), Team.B);
        CreateCombatSailor("Galdalf", new CombatPosition(2, 1), Team.B);
        CreateCombatSailor("Jenkins", new CombatPosition(2, 0), Team.B);
    }
